                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text('Electrician', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
                                  Container(
                                    width: 170,
                                    child: Text('An electrician is a tradesperson specializing in electrical wiring', style: TextStyle(fontSize: 12),),
                                  )
                                ],
                              )
                                ],
                      ...
                      return GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => SelectedCategories(value: value)));
                          },
