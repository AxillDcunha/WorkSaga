...
class _BookFreelancerState extends State<BookFreelancer> {
  ...
  Future<void> FinalBooking(String email, String mobileno, String address,
    ...
    final String cc = "https://worksaga.herokuapp.com/api/bookfreelancer/" +
        widget.freelancerId;
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 22, 0, 17),
                    child: ElevatedButton(
                      onPressed: () async {
                        FinalBooking(_email.text, _mobileno.text, _address.text,
