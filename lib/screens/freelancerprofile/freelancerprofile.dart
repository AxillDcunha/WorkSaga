...
class _FreelancerProfileState extends State<FreelancerProfile> {
  ...
  Future<FreelancerProfileModel> getprofile() async {
    late FreelancerProfileModel model;
    ...
    if (response.statusCode == 200) {
      ...
      model = FreelancerProfileModel.fromJson(data);
    }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder(
            future: getprofile(),
            builder: (context, AsyncSnapshot<FreelancerProfileModel> snapshot) {
